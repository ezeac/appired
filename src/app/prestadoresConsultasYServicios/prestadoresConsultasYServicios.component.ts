...
@Component({
	selector: "prestadoresConsultasYServicios",
	templateUrl: "./prestadoresConsultasYServicios.component.html",
	// styleUrls: ['./style.css'],
...
En caso de que necesite campos adicionales, agregar condicional en cargarDetalle (como "encontrar prestadoresConsultasYServicios") y sus variables necesarias de forma ordenada
...
export class PrestadoresConsultasYServiciosComponent{
	public titulo = "Página prestadoresConsultasYServicios";
	//VARIABLES GENERALES
	...
	redirigir(){
		/*this._router.navigate(['/prestadoresConsultasYServicios','valorPage']);*/
	}
